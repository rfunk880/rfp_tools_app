    ...
    <div class="row">
        ...
        {{-- <div class="col-md-2 mb-2">
            ...
            <select id="type" class="form-select" name="type">
                    ...
                    {!! arrayOptions(\App\Models\Calllog::$typeLabel, request('type')) !!}
            </select>
        </div> --}}
        ...
        <div class="col-md-2 mb-2">
            ...
            <input id="date_from" type="text" class="form-control dp"  name="date_from" value="{{ request('date_from')}}" placeholder="Date From">
        </div>
        
        <div class="col-md-2 mb-2">
            <label for="date_to">Date To</label>
            <input id="date_to" type="text" class="form-control dp" name="date_to" value="{{ request('date_to')}}" placeholder="Date To">
        </div>
